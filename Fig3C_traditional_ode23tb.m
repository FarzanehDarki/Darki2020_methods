...
v=10;   
J_HL=v;    %inputs to populations representing horizontal grating in the left eye
J_VR=v;    %inputs to populations representing vertical grating in the right eye
%% Wilson model 
Wilson=@(t,u)[...
...
x0=zeros(6,1); x0(1,1)=0.000001; %initialize conditions
tspan=[0 t_total];
...
title(['V1=V2=',num2str(v),',  g=',num2str(g),',  h=',num2str(h)])
hold on
